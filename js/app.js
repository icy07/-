 ...
 */
    ...
    (() => {
        ...
        function formQuantity() {
            document.addEventListener("click", (function(e) {
                ...
                if (targetElement.closest(".quantity__button")) {
                    let finalPrice = targetElement.closest(".slide__top-main").querySelector(".slide__final-price").querySelector("span");
                    let orPrice = targetElement.closest(".slide__top-main").querySelector(".slide__quan-price").querySelector("span");
                    let value = parseInt(targetElement.closest(".quantity").querySelector("input").value);
                    if (targetElement.classList.contains("quantity__button_plus")) {
                        value++;
                        finalPrice.textContent = value * +orPrice.textContent;
                    } else {
                        --value;
                        if (value < 1) value = 1;
                        finalPrice.textContent = value * +orPrice.textContent;
            ...
            let catalogInputs = document.querySelectorAll(".quantity__rea-inp");
            if (catalogInputs) catalogInputs.forEach((function(ind) {
                ind.addEventListener("input", (function() {
                    let finalPrice = ind.closest(".slide__top-main").querySelector(".slide__final-price").querySelector("span");
                    let orPrice = ind.closest(".slide__top-main").querySelector(".slide__quan-price").querySelector("span");
                    let value = ind.value;
                    if ("" == value || "0" == value) ind.value = "1";
                    finalPrice.textContent = +value * +orPrice.textContent;
                }));
            }));
        }
        ...
        function initSliders() {
            ...
            if (document.querySelector(".tiles__slider")) {
                let thumbsSwiper = new core(".tiles-thumb__slider", {
                    modules: [ Scrollbar ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
                ...
                new core(".tiles__slider", {
                    ...
                    navigation: {
                        prevEl: ".tiles__button-prev",
                        nextEl: ".tiles__button-next"
                    },
                    thumbs: {
                        swiper: thumbsSwiper
                    }
            ...
            if (document.querySelector(".slide__slider")) {
                let sliderArr = document.querySelectorAll(".slide__slider");
                sliderArr.forEach((e => {
                    let thumb = e.closest(".slide__top").querySelector(".thumb-slide__slider");
                    let scroll = e.closest(".slide__top").querySelector(".thumb-slide__scrollbar");
                    let thumbsSwiper2 = new core(thumb, {
                        modules: [ Scrollbar ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 3,
            ...
            if (document.querySelector(".gallery__slider")) {
                ...
                function mobileSlider() {
                    ...
                    if (window.innerWidth <= 940 && "false" == slider.dataset.mobile) {
                        mySwiper = new core(".gallery__slider", {
                            modules: [ Navigation ],
                            observer: true,
                            observeParents: true,
                            slidesPerView: 2,
            ...
            if (document.querySelector(".tiles__slider2")) {
                let thumbsSwiper = new core(".tiles-thumb__slider2", {
                    modules: [ Scrollbar ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
...
***************************************************************************** */
        ...
        let menuLi = document.querySelectorAll(".spoiler-block__li--arrow");
        let spoilers = document.querySelectorAll(".spoiler-block__title");
        if (navArr && menuLi && isMobile.any()) {
            navArr.forEach((e => {
                e.addEventListener("click", (item => {
                    item.preventDefault();
                    item.target.closest(".header__arrow-li").classList.toggle("active");
                }));
            }));
            menuLi.forEach((e => {
                e.addEventListener("click", (item => {
                    item.preventDefault();
                    item.target.closest(".spoiler-block__li--arrow").classList.toggle("active");
                }));
            }));
        }
        if (spoilers && document.documentElement.clientWidth > 950) spoilers.forEach((e => {
            e.classList.add("_spoller-active");
        }));
        let search = document.querySelectorAll(".header__search");
        let searchCross = document.querySelectorAll(".header__search-cross");
        if (search) {
            search.forEach((el => {
                el.addEventListener("click", (e => {
                    if (e.target.classList.contains("header__search-block")) e.target.closest(".header__search").classList.add("active");
                }));
            }));
            searchCross.forEach((el => {
                el.addEventListener("click", (e => {
                    e.target.closest(".header__search").classList.remove("active");
                }));
            }));
        }
        isWebp();
